...
const move = () => {
  gsap.set('.rocketManSVG', { scale: 0.5, autoAlpha: 1 })

  gsap.to('.rocketManSVG', {
    duration: 15,
    ease: 'power1.inOut',
...
<template>
  <div class="text">
    <div class="astr">
      <!-- <svg id="motionPath" stroke="transparent" viewBox="-20 0 557 190"> -->
      <path id="path" stroke="transparent" fill="none" d="M 0 0 Q 1571 302 1877 2001" />
      <!-- </svg> -->
      <svg
        class="rocketManSVG"
...
M323.5,240.6c2.4,3.5,2.4,7.8,0,12.7 M275.8,240.6c-2.4,3.5-2.4,7.8,0,12.7"
    ...
    <div class="button" alt="WANGJUNZHI">
      <i>W</i>
      <i>A</i>
      <i>N</i>
      <i>G</i>
...
.button {
  ...
  background-color: #171717;
  /* overflow: hidden; */
  transition: 3s cubic-bezier(0.5, 0.7, 0.4, 1);
}
