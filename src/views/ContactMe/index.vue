...
<template>
  <div class="content">
    <div class="cards">
      <div class="cardItem">
        <div class="inside">
          <img src="../../assets/imgs/1708150730501.png" alt="" />
        </div>
      </div>
      <div class="cardItem">
        <div class="inside">
    ...
    <div class="rightCon">
      <div class="time">
        <p class="time-text">
          <span>{{ getTimeStore.hour }}</span
          ><span class="time-sub-text">{{ getTimeStore.APM }}</span>
        </p>
        <p class="day-text">{{ getTimeStore.week }}th</p>
      </div>
      <div class="container">
        <svg
          id="bongo-cat"
...
.content {
  ...
  .cards {
    ...
    &:hover > .cardItem:not(:hover) .inside {
...
#laptop__code {
  -webkit-transform: rotateX(-37deg) rotateY(-46deg) rotateZ(-23deg) translateX(8px)
    translateY(20px) translateZ(-50px);

  transform: rotateX(-37deg) rotateY(-46deg) rotateZ(-23deg) translateX(8px) translateY(20px)
    translateZ(-50px);
}
</style>
